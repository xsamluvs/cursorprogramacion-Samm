...
icon = pygame.image.load('orcamala1.png')
pygame.display.set_icon(icon)

# jugador
PlayerImg=pygame.image.load('nutria1.png')
playerX=370
playery=480
playerX_change=0
...
for i in range(num_of_enemies):
    enemyImg.append(pygame.image.load('tiburondepredador1.png'))
...
# tridente
armaImg=pygame.image.load('tridente.png')
armaX=0
armaY=480
armaX_change=0
armaY_change=10
...
score_value=0
font=pygame.font.Font('sakitu_baelah_clean.zip',32)
...
# juego terminado
over_font=pygame.font.Font('super_crumble.zip',64)
